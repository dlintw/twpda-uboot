...
int do_auto_update_uboot_to_spi (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	unsigned char StartAddr[10]={0};
	unsigned char *DataBufferAddr=NULL;
	char *str_filesize = NULL;
...
void WriteSPIFlashDataByChar(unsigned int AddressOfFlag, unsigned char Data)
{
	unsigned char  CharData;
	unsigned char  StartAddr[3];
...
unsigned char ReadSPIFlashDataToBuffer(unsigned int AddressOfFlag, unsigned char *buffer, unsigned int length)
{
	unsigned char  CharData;
	unsigned char  StartAddr[3];
...
void WriteSPIFlashDataFromBuffer(unsigned int AddressOfFlag, unsigned char *buffer, unsigned int length)
{
	unsigned char  CharData;
	unsigned char  StartAddr[3];
